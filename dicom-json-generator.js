...
function conditionalMetaData(instance) {
  return {
    ...
    ...(instance.ContentSequence && {
      ContentSequence: instance.ContentSequence,
    }),
    ...
    ...(instance.EncapsulatedDocument && {
      EncapsulatedDocument: instance.EncapsulatedDocument,
    }),
